...
export function App() {
  return (
    <main className="flex min-h-svh flex-col bg-background text-foreground">
      ...
      <div className="flex flex-1 items-center justify-center px-4 pb-24 pt-10 sm:px-6">
        <section className="w-full max-w-3xl">
          ...
          <form className="mt-10" aria-label="Job search">
            <div className="flex min-h-16 items-center gap-3 rounded-[2rem] border border-border bg-card px-4 py-3 shadow-[0_18px_60px_rgb(16_24_32/0.11)] transition-colors focus-within:border-ring focus-within:ring-4 focus-within:ring-ring/20 dark:shadow-[0_18px_70px_rgb(0_0_0/0.34)] sm:gap-4 sm:px-5">
              <input
